...
class StoryManager {
    ...
    private val stories = listOf(
        ...
        Story(
            ...
            text = "A sleeping lion was awakened by a little mouse running over him.",
            ...
            imageResId = R.drawable.lion_mouse,
            availableLanguages = listOf("English", "Arabic", "Turkish")
        ),
        Story(
            id = 5,
            title = "The Tortoise and the Hare",
            text = "A hare was boasting about how fast he could run.",
            ...
            imageResId = R.drawable.tortoise_hare,
            availableLanguages = listOf("English", "Arabic", "Turkish")
        )
    )
